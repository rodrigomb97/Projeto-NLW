...
const atividade = {
  nome: "Almoço",
  data: new Date("2024-07-22 12:00"),
  finalizada: false
}
...
let atividades = [
  atividade,
    {
      nome: 'Caminhada',
      data: new Date("2024-07-22 09:00"),
      finalizada: false
    },
    {
      nome: 'Alimentar Bacon',
      data: new Date("2024-07-22 16:00"),
      finalizada: false
    },
]
...
const criarItemDeAtividade = (atividade) => {
  ...
  if(atividade.finalizada) {
    input = input + 'checked'
    //input += 'checked' (desta maneira ele soma o anterior automatico)
  }
